...
/** 
 * Acts as wrapper for ProxyCrawl Screenshots API.
 * @see <a href="https://proxycrawl.com/docs/screenshots-api">ProxyCrawl Screenshots API documentation</a>
 * 
 * @author ProxyCrawl
 */
public class ScreenshotsAPI extends API {
     ...
     * @see <a href="https://proxycrawl.com/docs/screenshots-api/parameters/#token">token documentation</a>
     ...
     * @see <a href="https://proxycrawl.com/docs/screenshots-api/response/#success">success documentation</a>
     */
    ...
    /**
     * @return The url sent back by ProxyCrawl when you set <a href="https://proxycrawl.com/docs/screenshots-api/parameters/#store">store</a> in the parameters.
     */
     ...
     * 
     * @param options
     * @see <a href="https://proxycrawl.com/docs/screenshots-api/parameters">parameters documentation</a>
     */
    @Override
