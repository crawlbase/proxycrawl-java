...
/** 
 * Acts as wrapper for ProxyCrawl Scraper API.
 * @see <a href="https://proxycrawl.com/docs/scraper-api">ProxyCrawl Scraper API documentation</a>
 * 
 * @author ProxyCrawl
 */
public class ScraperAPI extends API
{
     ...
     * @see <a href="hhttps://proxycrawl.com/docs/scraper-api/parameters/#token">token documentation</a>
     ...
     * @see <a href="https://proxycrawl.com/docs/scraper-api/response/#remaining-requests">remaining requests documentation</a>
     */
