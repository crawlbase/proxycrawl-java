...
/** 
 * Acts as wrapper for ProxyCrawl Crawling API.
 * @see <a href="https://proxycrawl.com/docs/crawling-api">ProxyCrawl Crawling API documentation</a>
 * 
 * @author ProxyCrawl
 */
public class API 
{
    ...
    private String proxyCrawlStatus;
    private String url;

    /**
     * @param token
     * Accepts a Normal token or Javascript token
     * @see <a href="https://proxycrawl.com/docs/crawling-api/parameters/#token">token documentation</a>
     ...
     * @see <a href="https://proxycrawl.com/docs/crawling-api/response/#body">body documentation</a>
     */
    ...
    /**
     * @return The status response that we (ProxyCrawl) receive when crawling the url sent in the request.
     * @see <a href="https://proxycrawl.com/docs/crawling-api/response/#original-status">original status documentation</a>
     */
    ...
    /**
     * @return The ProxyCrawl (pc) status code can be any status code and it's the code that ends up being valid.
     * @see <a href="https://proxycrawl.com/docs/crawling-api/response/#pc-status">pc status documentation</a>
     */
    public String getProxyCrawlStatus() {
        return proxyCrawlStatus;
    }

    /**
     * @return The original url that was sent in the request or the url of the redirect that ProxyCrawl followed.
     * @see <a href="https://proxycrawl.com/docs/crawling-api/response/#url">url documentation</a>
     */
     ...
     * @see <a href="https://proxycrawl.com/docs/crawling-api/parameters/#url">url documentation</a>
     * 
     * @param options
     * @see <a href="https://proxycrawl.com/docs/crawling-api/parameters">parameters documentation</a>
     */
    ...
    protected void extractHeaderFromMap(Map<String, String> map) {
        ...
        this.proxyCrawlStatus = map.get("pc_status");
    ...
    protected void extractHeaderFromResponse(HttpURLConnection httpConn) {
        ...
        this.proxyCrawlStatus = httpConn.getHeaderField("pc_status");
